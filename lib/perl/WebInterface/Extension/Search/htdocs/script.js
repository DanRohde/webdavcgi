...
$(document).ready(function() {
	...
	$(".action.search").click(function(event) {
		...
		$.get(window.location.pathname, { ajax: "getSearchForm", files: ToolBox.getSelectedFiles(this) }, function(response) {
			...
			dialog.dialog({ width: "auto", height: "auto", minWidth: 620, minHeight:400, maxWidth: $(window).width()-100, maxHeight: $(window).height()-100, beforeClose: function() { doFinalActions(dialog);}});
