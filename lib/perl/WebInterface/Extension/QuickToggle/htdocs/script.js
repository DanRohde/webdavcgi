...
$(document).ready(function() {
	...
	}).toggleClass("off", !ToolBox.cookie("settings.enable.thumbnails"));
	...
	$(".quicktoggle-button").on("click", function() {
		$(".quicktoggles",this).toggleClass("show-toggles");
	});
	$(".quicktoggles.popup").on("focusin", function() {
		$(this).addClass("quicktoggle-focus");
	});
	$(".quicktoggles-spacer,.quicktoggle.action").on("focusin", function() {
		$(this).parents(".quicktoggles.popup").addClass("quicktoggle-focus");
	});
	$(".quicktoggles-button,.quicktoggles.popup").siblings().on("focusin", function() {
		$(".quicktoggles.popup.quicktoggle-focus").removeClass("quicktoggle-focus");
	});
