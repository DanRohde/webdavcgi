...
$(document).ready(function() {
	...
	ToolBox.addFullscreenChangeListener(function() {  console.log("fullscreen changed!"+ToolBox.isFullscreen()); $(".quicktoggle.fullscreen").toggleClass("off", ToolBox.isFullscreen());  } );
