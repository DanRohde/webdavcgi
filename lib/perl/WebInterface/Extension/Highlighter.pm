    ...
    $self->{attributes} = $self->config(
        'attributes',
        {
            'color' => {
                ...
                style       => 'color',
                labelcss    => 'color: white; font-weight: bold; font-size: 8px; line-height: 10px;',
            ...
            'background-color' => {
                ...
                labelcss    => 'font-size: 8px; height: 12px; line-height: 10px;',
                colorpicker => 1,
                order       => 1,
            },
            'border' => {
                subpopupmenu => {
                   'border-color'   => {
                        ...
                        style       => 'border-color',
                        labelstyle  => 'background-color',
                        labelcss    => 'border-style: solid; border-width: 1px;color: white; font-weight: bold;font-size: 8px; line-height: 10px;',
                        colorpicker => 1,
                        order       => 1,
                    },
                    'border-width' => {
