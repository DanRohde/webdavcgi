...
$(document).ready(function() {
	...
	function handleAFSGroupManager(event) {
		...
		$.get(target, { ajax : "getAFSGroupManager", template: template }, function(response) {
			...
			groupmanager.dialog({modal: false, width: "auto", height: "auto", closeText: $("#close").html(), close: function() { $(".action.afsgroupmngr").removeClass("disabled"); groupmanager.remove();}}).show();
		});	
	}
