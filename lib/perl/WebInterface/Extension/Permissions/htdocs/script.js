...
$(document).ready(function() {
		$(".action.permissions").click(function(event){
			...
			$.get(target, {ajax: "getPermissionsDialog", template: template},function(response){
				...
				permissions.dialog({modal:true, width: "auto", height: "auto", closeText: $("#close").html(), close: function() {$(".action.permissions").removeClass("disabled"); permissions.remove();}}).show();
