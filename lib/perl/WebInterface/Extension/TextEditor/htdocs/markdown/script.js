    ...
    $.fn.markdownEditor = function(options) {
        ...
        function renderPreview() {
            if ($(".markdown-preview").is(":visible")) {
                ...
                var el=document.getElementById("markdown-editor-scroll-to-me");
        ...
        function handleToolbarActions(ev) {
            ...
            if (action == "split") {
                ...
                setPreviewSize();
                $(options["fullscreenElement"] ? options["fullscreenElement"] : "#markdown-editor").toggleClass("fullscreen");
        ...
        function renderToolbar() {
            if (!options.toolbar) options.toolbar = [ "sepfsflex", "bold","italic", "strikethrough", "sep", "hr", "br", "p", "sep", "heading","ul","ol", "sep", "code", "codeblock", "quote", "sep", "link", "image", "sep", "preview", "split", "sepflex", "fullscreen" ];
