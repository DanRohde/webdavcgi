...
$(document).ready(function() {
	...
	function du_initTreemap(dialog) {
		var colorStops = colorStops = [{ "val":0, "color":"#aa0000" },{ "val":0.2, "color":"#00aaaa" },{ "val":0.4, "color":"#aaaa00" },{ "val":0.6, "color":"#00aa00" },{ "val":0.8, "color":"#0000aa" },{ "val":1, "color":"#000000" },];
		$(".treemappanel",dialog).each(function(i,v) {
			var myLocation = ToolBox.stripSlash(window.location.pathname);
			var cache = new Array();
			$(v).treemap({ "dimensions": [800,600], "nodeData": $(v).data("mapdata"), "nodeBorderWidth":1, "colorStops" : colorStops,
	...
	function du_initStatistics(dialog) {
		$(".diskusage.statistics.piechart",dialog).each(function (i,v) {
			$.jqplot($(v).attr("id"), [ $(v).data("json").data ],{
					seriesDefaults: {
