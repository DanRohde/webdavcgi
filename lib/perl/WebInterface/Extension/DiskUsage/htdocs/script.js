...
$(document).ready(function() {
	...
	function du_initTreemap(dialog) {
		...
		colorStops["color2"] = [{ "val":0, "color":"#222222" },{ "val":0.2, "color":"#666666" },{ "val":0.4, "color":"#333333" },{ "val":0.6, "color":"#555555" },{ "val":0.8, "color":"#444444" },{ "val":1, "color":"#000000" }];
		...
		$(".treemappanel",dialog).each(function(i,v) {
			...
			$(v).treemap({ "dimensions": $(".treemap.dimensions.active",dialog).data("dimensions"), 
							...
							"leafNodeBodyGradient":function(ctx,rect,rgb){
									...
									var r2 = Math.max(rect[2],rect[3])*0.7;
									var x = rect[0]+rect[2]*Math.random();
