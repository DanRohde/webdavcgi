...
function startAutoRefresh(timeout) {
	...
	autorefreshinterval = window.setInterval('refreshTimeout()',1000);
	return false;
}
...
function toggleAutoRefresh() {
	...
	if (autorefreshinterval != null) {
		...
		document.getElementById('autorefreshpauseresume').innerHTML='&gt;';
		...
		document.getElementById('autorefreshpauseresume').innerHTML='II';
		autorefreshinterval = window.setInterval('refreshTimeout()',1000);
	}
	return false;
}
