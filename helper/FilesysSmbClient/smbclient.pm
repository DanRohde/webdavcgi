...
*smbc_getNetbiosName = *smbclientc::smbc_getNetbiosName;
*smbc_setNetbiosName = *smbclientc::smbc_setNetbiosName;
*smbc_getWorkgroup = *smbclientc::smbc_getWorkgroup;
*smbc_setWorkgroup = *smbclientc::smbc_setWorkgroup;
*smbc_getUser = *smbclientc::smbc_getUser;
*smbc_setUser = *smbclientc::smbc_setUser;
...
*smbc_getOptionFullTimeNames = *smbclientc::smbc_getOptionFullTimeNames;
*smbc_setOptionFullTimeNames = *smbclientc::smbc_setOptionFullTimeNames;
*smbc_getOptionOpenShareMode = *smbclientc::smbc_getOptionOpenShareMode;
*smbc_setOptionOpenShareMode = *smbclientc::smbc_setOptionOpenShareMode;
*smbc_getOptionUserData = *smbclientc::smbc_getOptionUserData;
*smbc_setOptionUserData = *smbclientc::smbc_setOptionUserData;
*smbc_getOptionSmbEncryptionLevel = *smbclientc::smbc_getOptionSmbEncryptionLevel;
*smbc_setOptionSmbEncryptionLevel = *smbclientc::smbc_setOptionSmbEncryptionLevel;
*smbc_getOptionCaseSensitive = *smbclientc::smbc_getOptionCaseSensitive;
*smbc_setOptionCaseSensitive = *smbclientc::smbc_setOptionCaseSensitive;
*smbc_getOptionBrowseMaxLmbCount = *smbclientc::smbc_getOptionBrowseMaxLmbCount;
*smbc_setOptionBrowseMaxLmbCount = *smbclientc::smbc_setOptionBrowseMaxLmbCount;
*smbc_getOptionUrlEncodeReaddirEntries = *smbclientc::smbc_getOptionUrlEncodeReaddirEntries;
*smbc_setOptionUrlEncodeReaddirEntries = *smbclientc::smbc_setOptionUrlEncodeReaddirEntries;
*smbc_setOptionOneSharePerServer = *smbclientc::smbc_setOptionOneSharePerServer;
...
*smbc_setFunctionAuthData = *smbclientc::smbc_setFunctionAuthData;
...
*smbc_creat = *smbclientc::smbc_creat;
*smbc_read = *smbclientc::smbc_read;
*smbc_write = *smbclientc::smbc_write;
...
*smbc_getdents = *smbclientc::smbc_getdents;
*smbc_readdir = *smbclientc::smbc_readdir;
*smbc_telldir = *smbclientc::smbc_telldir;
*smbc_lseekdir = *smbclientc::smbc_lseekdir;
...
*smbc_statvfs = *smbclientc::smbc_statvfs;
*smbc_fstatvfs = *smbclientc::smbc_fstatvfs;
*smbc_ftruncate = *smbclientc::smbc_ftruncate;
*smbc_chmod = *smbclientc::smbc_chmod;
*smbc_utimes = *smbclientc::smbc_utimes;
*smbc_setxattr = *smbclientc::smbc_setxattr;
*smbc_lsetxattr = *smbclientc::smbc_lsetxattr;
*smbc_fsetxattr = *smbclientc::smbc_fsetxattr;
*smbc_getxattr = *smbclientc::smbc_getxattr;
*smbc_lgetxattr = *smbclientc::smbc_lgetxattr;
*smbc_fgetxattr = *smbclientc::smbc_fgetxattr;
*smbc_removexattr = *smbclientc::smbc_removexattr;
*smbc_lremovexattr = *smbclientc::smbc_lremovexattr;
*smbc_fremovexattr = *smbclientc::smbc_fremovexattr;
*smbc_listxattr = *smbclientc::smbc_listxattr;
*smbc_llistxattr = *smbclientc::smbc_llistxattr;
*smbc_flistxattr = *smbclientc::smbc_flistxattr;
*smbc_set_credentials = *smbclientc::smbc_set_credentials;
*smbc_set_credentials_with_fallback = *smbclientc::smbc_set_credentials_with_fallback;
*w_int2mode = *smbclientc::w_int2mode;
*w_int2offt = *smbclientc::w_int2offt;
*w_offt2int = *smbclientc::w_offt2int;
*w_offt2str = *smbclientc::w_offt2str;
